...
const getAnchorCoordinates = ({ width, height, x, y }: RectCoords): AnchorCoords[] => {
  return [
    ...
    { priority: 0.8, x, y },
    // top center
    { priority: 0.9, x: x + width / 2, y },
    // top right
    { priority: 0.8, x: x + width, y },
    // right center
    { priority: 1, x: x + width, y: y + height / 2 },
    // right bottom
    { priority: 0.8, x: x + width, y: y + height },
    // bottom center
    { priority: 0.9, x: x + width / 2, y: y + height },
    // left bottom
    { priority: 0.8, x, y: y + height },
    // left center
    { priority: 1, x, y: y + height / 2 },
  ];
};
